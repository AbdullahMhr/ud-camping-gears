        ...
        <div className="min-h-screen flex bg-white font-sans">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center p-4 sm:p-6 lg:p-8 xl:p-12">
                <div className="max-w-md w-full mx-auto">
                    ...
                    <div className="mb-5">
                        <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-1 tracking-tight">Create an account</h1>
                        <p className="text-gray-500 text-sm">Join us to start exploring premium gear.</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="relative flex py-2 items-center">
                            ...
                            <span className="flex-shrink-0 mx-4 text-gray-400 text-xs uppercase tracking-wider font-medium">Or register with email</span>
                            <div className="flex-grow border-t border-gray-100"></div>
                        </div>
                        <form onSubmit={handleEmailRegister} className="space-y-3">
                            <div>
                                <label className="block text-[11px] font-bold text-gray-900 uppercase tracking-wider mb-1.5 ml-1">Full Name</label>
                                <input
                                    type="text"
                            ...
                            <div className="pt-1">
                                <label className="flex items-start gap-2 cursor-pointer">
                                    <input type="checkbox" required className="mt-0.5 w-3.5 h-3.5 rounded border-gray-300 text-[#0b3c2e] focus:ring-[#0b3c2e]" />
                                    <span className="text-[13px] text-gray-500 leading-relaxed font-medium">
                                        I agree to the <Link href="/terms" className="text-[#0b3c2e] font-bold hover:underline">Terms of Service</Link> and <Link href="/privacy" className="text-[#0b3c2e] font-bold hover:underline">Privacy Policy</Link>
                                    </span>
                                </label>
                            </div>
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className={`w-full mt-3 bg-[#0b3c2e] text-white font-bold py-2.5 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 group text-sm ${!isLoading ? 'hover:bg-[#092e23] hover:-translate-y-0.5 shadow-green-900/20' : 'opacity-70 cursor-not-allowed shadow-none'}`}
                            >
                    ...
                    <div className="mt-5 text-center">
                        <p className="text-gray-500 font-medium text-sm">
                            Already have an account? <Link href="/login" className="text-[#0b3c2e] font-bold hover:underline">Sign in</Link>
                        </p>
                    </div>
                </div>
            </div>
